...
public class CosmeticController {
	...
	public AjaxResult sendMail(CosmeticCounsel cosmeticConsel, HttpServletRequest req) throws Exception, MessagingException {
        ...
        String html = "<table style='border: 1px solid #dddddd; border-collapse: collapse; margin: 0 auto;'>"
	        		+ "		<tr style='border: 1px solid #dddddd; border-collapse: collapse; height: auto;'>"
	        		+ "			<td colspan='2'><img src='http://localhost:8008/second-life/images/mail.png' width='1000'></td>"
	        		+ "		</tr>"
    				+ "		<tr style='border: 1px solid #dddddd; border-collapse: collapse; height: 30px;'>"
    				+ "			<th style='border: 1px solid #dddddd; border-collapse: collapse; width: 100px;'>이름</th>"
    				+ "			<td style='border: 1px solid #dddddd; border-collapse: collapse; padding-left: 10px;'>"+ cosmeticConsel.getName() +"</td>"
    				+ "		</tr>"
    				+ "		<tr style='border: 1px solid #dddddd; border-collapse: collapse; height: 30px;'>"
    				+ "			<th style='border: 1px solid #dddddd; border-collapse: collapse;'>나이</th>"
    				+ "			<td style='border: 1px solid #dddddd; border-collapse: collapse; padding-left: 10px;'>"+ cosmeticConsel.getAge() +"</td>"
    				+ "		</tr>"
    				+ "		<tr style='border: 1px solid #dddddd; border-collapse: collapse; height: 30px;'>"
    				+ "			<th style='border: 1px solid #dddddd; border-collapse: collapse;'>연락처</th>"
    				+ "			<td style='border: 1px solid #dddddd; border-collapse: collapse; padding-left: 10px;'>"+ cosmeticConsel.getTel() +"</td>"
    				+ "		</tr>"
    				+ "		<tr style='border: 1px solid #dddddd; border-collapse: collapse; height: 30px;'>"
    				+ "			<th style='border: 1px solid #dddddd; border-collapse: collapse;'>시술법</th>"
    				+ "			<td style='border: 1px solid #dddddd; border-collapse: collapse; padding-left: 10px;'>"+ cosmeticConsel.getSurgeryPart() +"</td>"
    				+ "		</tr>"
    				+ "		<tr style='border: 1px solid #dddddd; border-collapse: collapse; height: 30px;'>"
    				+ "			<th style='border: 1px solid #dddddd; border-collapse: collapse;'>상담내용</th>"
    				+ "			<td style='border: 1px solid #dddddd; border-collapse: collapse; padding-left: 10px;'>"+ cosmeticConsel.getContent() +"</td>"
    				+ "		</tr>"
    				+ "		<tr style='border: 1px solid #dddddd; border-collapse: collapse; height: 30px;'>"
    				+ "			<th style='border: 1px solid #dddddd; border-collapse: collapse;'>첨부파일</th>"
